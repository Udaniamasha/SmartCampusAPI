...
/**
 * Represents a sensor deployed within a room on the Smart Campus.
 * A sensor is always linked to exactly one room via roomId.
 *
...
public class Sensor {
    ...
    private String roomId;         // Foreign key linking to the Room where this sensor lives
